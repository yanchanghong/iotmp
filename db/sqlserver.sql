...
INSERT INTO sys_user (user_id, username, password, salt, email, mobile, status, create_user_id, create_time) VALUES ('1', 'admin', '9ec9750e709431dad22365cabc5c625482e574c74adaebba7dd02f1129e4ce1d', 'YzcmCZNvbXocrsz9dm8e', 'root@iot.io', '13612345678', '1', '1', '2016-11-11 11:11:11');
...
INSERT INTO sys_menu(menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES (5, 1, 'SQL监控', 'http://localhost:8080/iot-fast/druid/sql.html', NULL, 1, 'sql', 4);
...
INSERT INTO schedule_job (bean_name, params, cron_expression, status, remark, create_time) VALUES ('testTask', 'iot', '0 0/30 * * * ?', '0', '参数测试', '2016-12-01 23:16:46');
